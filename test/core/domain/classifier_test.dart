...
void main() {
  group('Classifier', () {
    ...
    test('should classify PIX EMV payload correctly', () {
      // Simple PIX EMV format (simplified for testing)
      const rawPix = '00020126580014br.gov.bcb.pix0136123e4567-e12b-12d3-a456-426614174000520400005303986540510.005802BR5913FULANO DE TAL6008BRASILIA62070503***6304A4F3';
