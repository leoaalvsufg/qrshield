...
void main() {
  group('RiskBadge Widget', () {
    ...
    testWidgets('should display safe risk badge correctly', (tester) async {
      ...
      await tester.pumpWidget(
        createTestWidget(
          RiskBadge.fromRiskScore(riskScore),
        ),
      );
    ...
    testWidgets('should display suspicious risk badge correctly', (tester) async {
    ...
    testWidgets('should display dangerous risk badge correctly', (tester) async {
    ...
    testWidgets('should show score when enabled', (tester) async {
      ...
      await tester.pumpWidget(
        createTestWidget(
          RiskBadge.fromRiskScore(riskScore, showScore: true),
        ),
      );
    ...
    testWidgets('should not show score when disabled', (tester) async {
      ...
      await tester.pumpWidget(
        createTestWidget(
          RiskBadge.fromRiskScore(riskScore, showScore: false),
        ),
      );
  ...
  group('CompactRiskBadge Widget', () {
    ...
    testWidgets('should display compact safe badge', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const CompactRiskBadge(level: 'safe'),
        ),
      );
    ...
    testWidgets('should display compact suspicious badge', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const CompactRiskBadge(level: 'suspicious'),
        ),
      );
    ...
    testWidgets('should display compact dangerous badge', (tester) async {
      await tester.pumpWidget(
        createTestWidget(
          const CompactRiskBadge(level: 'danger'),
        ),
      );
